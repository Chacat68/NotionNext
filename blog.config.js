...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CHACAT', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'I think a life properly lived is just learn, learn, learn all the time.', // 作者简介
  ...
  POSTS_SHARE_SERVICES:
    ...
    'wechat,facebook,twitter,telegram,reddit,whatsapp,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'ktj3dhm0ef', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
